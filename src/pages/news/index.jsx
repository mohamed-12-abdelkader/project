      ...
      <div className="text-center">
        ...
        <div className="w-[60%] m-auto text-center ">
          <p className="text-[#353939] mt-2">
            ...
            الأورام. كل ما هو جديد الذي يسهم في تعزيز جهودنا لمكافحة السرطان
            وتحسين حياة المرضى.
          </p>
        </div>
      </div>
      ...
      <div className="flex   w-[95%] m-auto">
        <div className="w-[50%]">
          ...
          <h1 className="text-xl font-bold">
            ...
            السرطان. الورشة ستتناول تقنيات ال CAR-T-CEll الجديدة في علاج
            السرطان.
          </h1>
          <p>
            ...
            الذكاء الاصطناعي في التشخيص والعلاج. كان للمؤتمر دور كبير في تعزيز
            التعاون بين المؤسسات البحثية المختلفة، وتبادل الخبرات والأفكار بين
            العلماء، مما يعزز من جهود مكافحة السرطان. إلى جانب ذلك، شهد المؤتمر
            حضوراً واسعاً من الطلاب والباحثين الناشئين، مما يساهم في تطوير الجيل
            القادم من العلماء والباحثين. قدم المؤتمر فرصة فريدة للمشاركين
            للاستفادة من المحاضرات والورش العملية، وكذلك لمناقشة أحدث الابتكارات
            والمستجدات مع قادة الفكر في هذا المجال. هذا النجاح الكبير للمؤتمر
            يعزز من مكانة جمعية داعم كجهة رائدة في دعم الأبحاث العلمية وتحقيق
            التقدم في مجال علاج الأورام.....
          </p>
        </div>
        <div className="w-[50%] mx-3">
          <div className="h-[150px] w-[100%] flex m-2 ">
            <Image
              src={img}
            ...
            <div className="my-3 mx-2">
              ...
              <p className="m-1">
                ...
                مجال السرطان. الورشة ستتناول تقنيات ال CAR-T-CEll الجديدة في
                علاج السرطان.
              </p>
            </div>
          </div>
