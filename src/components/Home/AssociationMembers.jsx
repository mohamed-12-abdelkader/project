      ...
      <div className="relative select-none" dir="rtl">
        ...
        >
          ...
          <div className="splide__arrows association-arrows">
            <button
              className="splide__arrow association-arrow association-next splide__arrow--next slide-btn-theme left-[10px] xxl:left-[-32px] top-[31.7%]"
            >
              <GoArrowLeft className="text-2xl text-white" />
            </button>
            <button
              className="splide__arrow association-arrow association-prev splide__arrow--prev slide-btn-theme right-[10px] xxl:right-[-32px] top-[31.7%]"
            >
